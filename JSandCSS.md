...
<tr><td><img width="768px" src="https://user-images.githubusercontent.com/113126174/194795584-39e2f1b9-6c8a-41e4-8482-8702729bdb5f.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>screenshot after logout is clicked<br></p>
</td></tr>
</table></td></tr>
</table></td></tr>
...
<tr><td> <em>Response:</em> <p>I made the navigation horizontal by using display: inline; within nav ul li<br>{ }. display: inline allowed all of the text to fit into one<br>line rather than the split lines like it was before.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 2: </em> Briefly explain how you remove the navigation list item markers</td></tr>
<tr><td> <em>Response:</em> <p>I removed the&nbsp;<br></p><br></td></tr>
<tr><td> <em>Sub-Task 3: </em> Briefly explain how you gave the navigation a background</td></tr>
<tr><td> <em>Response:</em> <p>I gave the navigation a background by using background-color with an rgb value<br>within nav ul { } in style. It gave the rgb value I<br>specified.<br></p><br></td></tr>
...
<tr><td> <em>Response:</em> <p>I made the links change color on mouseover by using a:hover to target<br>the &lt;a&gt; tags which contain the links.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 5: </em> Briefly explain how you changed the challenge list bullet points to checkmarks (✓)</td></tr>
<tr><td> <em>Response:</em> <p>I changed the challenge list bullet points to checkmarks by using list-style-type: and<br>making the specified value a checkmark.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 6: </em> Briefly explain how you made the first character of the h1 tags and anchor tags uppercased</td></tr>
<tr><td> <em>Response:</em> <p>I made the first character of the h1 tags and anchor tags uppercased<br>by using text-transform: uppercase while focusing on the first letter of h1 and<br>a by using h1::first-letter and a::firstletter.<div><br></div><br></p><br></td></tr>
<tr><td> <em>Sub-Task 7: </em> Briefly explain/describe your custom styling of your choice</td></tr>
<tr><td> <em>Response:</em> <p>The custom styling of my choice is making the intitial text aqua using<br>color:aqua. I also made it so when the link is focused (by clicking<br>on it) it turns red and stays red until you click on something<br>else. It works because those commands in HTML allows it to do those<br>things I specified.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 8: </em> Briefly explain how the styling for the challenge list doesn't impact the navigation list</td></tr>
<tr><td> <em>Response:</em> <p>The styling for the challenge list does not impact the navigation list because<br>when making the style edits, I specified where I wanted the edits to<br>be. For example, nav ul li { } allowed all the edits within<br>the { } to be with items that share all those tags.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 9: </em> Briefly explain how you updated the content of the h1 tag with the link text</td></tr>
<tr><td> <em>Response:</em> <p>I tried doing this by grabbing the currentNavigation using the innertext of the<br>element that was clicked on as well as updateCurrentPage(currentNavigation) but I was unsuccessful.<br></p><br></td></tr>
